        ...
        <div className="w-full h-full flex font-FiraCode">
          <div className=" xs:w-full  h-full border-r border-r-border-color justify-center pt-16 flex">
            <form action="" className="flex flex-col xs:w-[85%] lg:w-[70%]">
              <label htmlFor="" className="text-text_primary">
                {" "}
                _name{" "}
              </label>
              <input
                className="bg-[#011221] text-white mt-2 p-2 border border-[#546476] rounded-md"
                type="text"
                name=""
                id=""
              />
              <label className="text-text_primary" htmlFor="">
                _email
              </label>
              <input
                className="bg-[#011221] text-white mt-2 p-2 border border-[#546476] rounded-md"
              ...
              <textarea
                className="bg-[#011221] text-white mt-2 p-2 border border-[#546476] active:border-[#607B96] rounded-md "
                rows={5}
                name=""
                id=""
              ></textarea>
              ...
              <button
                className="text-left mt-3 text-[#FFFFFF] bg-[#111f2d] py-2 px-3 rounded-xl w-[163px]"
                type="submit"
              >
                submit message
              </button>
