...
const Home = () => {
  ...
  return (
    <div className="bg-primary min-h-[calc(100vh-55px)] flex justify-center items-center gap-5">
      <div className="lg:h-[400px] xs:min-h-[calc(80vh-134px)] lg:w-[43%] flex flex-col xs:justify-between xs:items-center lg:justify-center gap-10 lg:pl-19">
        <div className="xs:w-[85%]  lg:w-full">
          ...
          <h2 className="lg:text-6xl xs:text-4xl font-bold text-white font-FiraRegular" ref={nameRef}>
            Ankeet Kumar Sah
          </h2>
